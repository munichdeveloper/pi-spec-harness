...
Aktueller Release-Kandidat: **v0.4.3**. Die installierten Workflow-Caller
...
erstellt. Details: [Release Notes v0.4.3](docs/releases/v0.4.3.md).
...
`pi install git:github.com/munichdeveloper/pi-spec-harness@v0.4.3`
...
Voraussetzungen: Node.js 20.19+, `gh` CLI mit bestehender Anmeldung und
...
HARNESS_RELEASE_TAG=v0.4.3 npm run release:verify-tag # lokalen Tag vor dem Push prüfen
```
